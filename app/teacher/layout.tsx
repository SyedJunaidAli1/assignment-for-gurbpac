...
const navItems = [
  ...
  { name: 'My Content', href: '/teacher/my-content', icon: ListOrdered },
];
...
export default function TeacherLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-border bg-background/80 px-4 backdrop-blur-md lg:pl-72">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-lg font-semibold lg:text-xl">
            {navItems.find(item => item.href === pathname)?.name || 'Teacher Portal'}
          </h1>
        </div>
      ...
      {/* Main Content */}
      <main className="min-h-[calc(100-4rem)] p-4 lg:pl-72 lg:p-8">
